...
view  dx {
        match-clients { dx; zhdx; 172.25.20.19; !192.168.0.19; !192.168.1.19; };
	zone "." IN {
		type hint;
		file "named.ca";
	};
...
view  wt {
        match-clients { wt; zhlt; !172.25.20.19; 192.168.0.19; !192.168.1.19; };
        zone "." IN {
                type hint;
                file "named.ca";
        };
...
view  other {
        match-clients { any; !172.25.20.19; !192.168.0.19; 192.168.1.19; };
        zone "." IN {
                type hint;
                file "named.ca";
        };
...
www     A       1.1.1.1
BBC
cat > /var/named/abc.com.zhdx.zone <<THH
\$TTL 1D
@       IN SOA  ns1.abc.com. rname.invalid. (
                                        10      ; serial
                                        1D      ; refresh
...
cat > /var/named/abc.com.zhlt.zone <<BDF
\$TTL 1D
@       IN SOA  ns1.abc.com. rname.invalid. (
                                        10      ; serial
                                        1D      ; refresh
...
#解压标签文件
tar xf /opt/dns_config.tar.gz -C /
